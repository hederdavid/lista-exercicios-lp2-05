...
public class Main {
    public static void main(String[] args) {
        ...
        Set<ContatoTelefonico> listaTelefonica = new HashSet<>();
        ...
        do {
            ...
            switch (opcaoEscolhida) {
                case 1 -> {
                    ...
                    ContatoTelefonico novoContato = new ContatoTelefonico(nome, sobrenome, email, codigoPais, telefone, categoria);
                    if (!listaTelefonica.isEmpty()) {
                        ...
                        if (!jaTem) {
                            listaTelefonica.add(novoContato);
                        }
